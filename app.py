...
def welcome():
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <br>
    <a href="/api/v1.0/2017-05-015">/api/v1.0/2017-05-01</a>
    </li>
    <br>
    <li>
    ...
    <br>
    <br>
    <a href="/api/v1.0/2017-05-15/2017-06-14">/api/v1.0/2017-05-15/2017-06-14</a>
    </li>
    <br>
    </ul>
    </html>
...
def precipitation():
    ...
    last_data_pnt = dt.datetime.strptime(max_date, "%Y-%m-%d") - dt.timedelta(days=366)
    
    # Perform a query to retrieve the data and precipitation scores
    results_precipitation = session.query(Measurement.date, Measurement.prcp).filter(Measurement.date >= last_data_pnt ).all()
...
def tobs(): 
    ...
    last_data_pnt  = dt.datetime.strptime(max_date, "%Y-%m-%d") - dt.timedelta(days=366)
    # Query tobs
    results_tobs = session.query(Measurement.date, Measurement.tobs).filter(Measurement.date >= last_data_pnt ).all()
